...
This application is hosted on **Vercel**, offering a fast and reliable platform for deployment. You can view a live demo by visiting [https://anime-portal-custom.vercel.app/](https://anime-portal-custom.vercel.app/).

---

## Key Features

- **Search Functionality**: Easily find anime and manga by title.
...
- **Smooth Integration**: Enhanced with Angular Material for a seamless user interface and experience.
...
- **Angular 19.0.2**: The framework used for building the application’s front end.
